...
/**
 * @param $filename
 * @return mixed tra ve phan mo rong cua f
 */
function getFilextension($filename)
{
...
function uploadFile($file, $path, $allowType, $maxSize){
    ...
    if(count($result["error"]) == 0){
        $filename = time() .'_' .$filename ; // tim ()1234566
        $path = $path . "/" . $filename;
...
//                    echo "</pre>";
                    ...
                    $allowType = ['jpg', 'jpeg', 'doc' , 'docx', 'pdf'];
                    $maxSize = 3000000;
